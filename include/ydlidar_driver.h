...
class YDlidarDriver {
  ...
  */
  explicit YDlidarDriver(uint8_t drivertype = LIDAR_DEVICE_DRIVER_TYPE_SERIALPORT);
  ...
  */
  ...
  /**
       * @brief YDlidarDriver::setScanFrequency
       * @param frequency
       * @param timeout
       * @return
       */
  result_t setScanFrequency(scan_frequency& frequency, uint32_t timeout = DEFAULT_TIMEOUT);
